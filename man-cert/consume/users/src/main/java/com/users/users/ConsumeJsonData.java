...
public class ConsumeJsonData {
    public void ConsumeData() {
        ...
        String KubernetesServer1 = "kafka-1.kafka.confluent.svc.cluster.local:9092";
        ...
        properties.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, KubernetesServer3);
        ...
        //         "org.apache.kafka.common.security.plain.PlainLoginModule required username=\"" + apiKey
        //                 + "\" password=\"" + apiSecret + "\";");
